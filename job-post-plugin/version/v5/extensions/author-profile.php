...
function wzjob_author_display_box($content) {
    ...
    if (!empty($opts['verified'])) {
        $verified_badge = '<span class="wzjob_verified_badge" title="Verified Author">✔</span>';
    }
...
add_action('wp_head', function () {
    ...
    .wzjob_verified_badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;background:#1da1f2;color:#fff;font-size:12px;border-radius:50%;font-weight:bold;margin-left:6px;}
