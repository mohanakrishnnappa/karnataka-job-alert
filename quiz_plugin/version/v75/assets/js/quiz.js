if (!document.querySelector(".wzq-wrapper")) {
    ...
    function loadNextBatch(callback) {
        ...
        if (pointer >= order.length || isLoading) return;
    ...
    function showQuestion(index) {
        ...
        console.log("👉 Showing index:", index, questions[index]);
        ...
        questions.forEach(q => {
            ...
            q.style.display = "none"; // 🔥 hide all
        });

        questions[index].classList.add("active");
        questions[index].style.display = "block"; // 🔥 show current
    ...
    nextBtn.addEventListener("click", () => {
        ...
        // 🔥 If next question not loaded → load first
        ...
        startBtn.addEventListener("click", function () {
            ...
            fetch(wzq_ajax.url, {
                ...
                .then(ids => {
                    ...
                    // 🚀 LOAD FIRST BATCH
                    loadNextBatch(() => {
                        showQuestion(0); // 🔥 SHOW FIRST QUESTION AFTER LOAD
                    });
